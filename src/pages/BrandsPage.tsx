  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-content px-4 py-8">
        ...
        <h1 className="mb-2 text-center text-3xl font-bold text-[var(--store-text-primary)]">
          ماركات {STORE.name}
        </h1>
        <p className="mb-8 text-center text-[var(--store-text-secondary)]">
          تسوقي من أشهر ماركات العناية والجمال
        </p>
          ...
          {mockBrandLogos.map((b) => (
            ...
            >
              <ResponsiveImage
                ...
                height={56}
              />
              <span className="text-sm font-semibold text-[var(--store-text-primary)]">
                {b.name}
              </span>
            </Link>
          ))}
